...
class Fashionpedia(data.Dataset):
    num_classes = 46
    ...
    def __init__(self, opt, split):
        ...
        self.data_dir = os.path.join(opt.data_dir, 'fashionpedia')
        ...
        if split == 'test':
            ...
            self.annot_path = os.path.join(
                self.data_dir, 'annotations',
                'instances_attributes_{}2020.json'.format(split))
        self.max_objs = 50
        self.class_name = [
            '__background__', 'shirt, blouse', 'top, t-shirt, sweatshirt',
        ...
        print('==> initializing fashionpedia {} data.'.format(split))
